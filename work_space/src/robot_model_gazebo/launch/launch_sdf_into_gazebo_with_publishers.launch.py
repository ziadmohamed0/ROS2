...
def generate_launch_description():
    ...
    #     package="rviz2",
    #     executable="rviz2",
    #     arguments=["-d", os.path.join(pkg_robot_model_gazebo, "rviz", "diff_drive.rviz")],
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            "/world/diff_drive/model/vehicle_green/joint_state@sensor_msgs/msg/JointState[ignition.msgs.Model",
        ...
        remappings=[
            ...
            ("/world/diff_drive/model/vehicle_green/joint_state", "/green_robot/joint_states"),
        ],
