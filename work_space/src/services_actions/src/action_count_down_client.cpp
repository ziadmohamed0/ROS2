/**
 * @file action_count_down_client.cpp
 * @author Ziad Mohammed Fathy
 * @brief count down action client
 * @version 0.1
 * @date 2025-08-20
 */
...
#include "services_actions/action/countdown.hpp"

class CountdownActionClient : public rclcpp::Node
{
public:
  using Countdown = services_actions::action::Countdown;
