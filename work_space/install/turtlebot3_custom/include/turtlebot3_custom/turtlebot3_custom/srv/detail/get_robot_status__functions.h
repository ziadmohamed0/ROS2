...
#ifndef TURTLEBOT3_CUSTOM__SRV__DETAIL__GET_ROBOT_STATUS__FUNCTIONS_H_
#define TURTLEBOT3_CUSTOM__SRV__DETAIL__GET_ROBOT_STATUS__FUNCTIONS_H_
 ...
 * calls
 * turtlebot3_custom__srv__GetRobotStatus_Request__init().
...
/**
 * It calls
 * turtlebot3_custom__srv__GetRobotStatus_Request__fini()
 ...
 * turtlebot3_custom__srv__GetRobotStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * turtlebot3_custom__srv__GetRobotStatus_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtlebot3_custom__srv__GetRobotStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlebot3_custom
...
/**
 * It calls
 * turtlebot3_custom__srv__GetRobotStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlebot3_custom
...
/**
 * It allocates the memory for the array and calls
 * turtlebot3_custom__srv__GetRobotStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlebot3_custom
...
/**
 * It calls
 * turtlebot3_custom__srv__GetRobotStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLEBOT3_CUSTOM__SRV__DETAIL__GET_ROBOT_STATUS__FUNCTIONS_H_
