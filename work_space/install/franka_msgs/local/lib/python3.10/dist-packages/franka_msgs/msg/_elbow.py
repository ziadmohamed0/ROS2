...
class Elbow(metaclass=Metaclass_Elbow):
    ...
    def __eq__(self, other):
        ...
        if any(self.position != other.position):
            return False
        if any(self.desired_position != other.desired_position):
            return False
        if any(self.commanded_position != other.commanded_position):
            return False
        if any(self.commanded_velocity != other.commanded_velocity):
            return False
        if any(self.commanded_acceleration != other.commanded_acceleration):
            return False
        return True
