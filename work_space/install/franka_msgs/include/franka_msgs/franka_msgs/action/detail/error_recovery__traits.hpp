...
inline std::string to_yaml(const ErrorRecovery_Goal & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_Goal & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_Goal & msg)
{
...
inline void to_flow_style_yaml(
  const ErrorRecovery_Result & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const ErrorRecovery_Result & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_Result & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_Result & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ErrorRecovery_Feedback & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const ErrorRecovery_Feedback & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_Feedback & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_Feedback & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ErrorRecovery_SendGoal_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const ErrorRecovery_SendGoal_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_SendGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_SendGoal_Request & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ErrorRecovery_SendGoal_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: accepted
...
inline std::string to_yaml(const ErrorRecovery_SendGoal_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_SendGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_SendGoal_Response & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ErrorRecovery_GetResult_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const ErrorRecovery_GetResult_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_GetResult_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_GetResult_Request & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ErrorRecovery_GetResult_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const ErrorRecovery_GetResult_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_GetResult_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_GetResult_Response & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const ErrorRecovery_FeedbackMessage & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const ErrorRecovery_FeedbackMessage & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::action::ErrorRecovery_FeedbackMessage & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::action::ErrorRecovery_FeedbackMessage & msg)
{
  return franka_msgs::action::to_yaml(msg);
}
