...
class Metaclass_TimedRotation_SendGoal_Event(type):
    """Metaclass of message 'TimedRotation_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__timed_rotation__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__timed_rotation__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__timed_rotation__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__timed_rotation__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__timed_rotation__send_goal__event
...
class TimedRotation_SendGoal_Event(metaclass=Metaclass_TimedRotation_SendGoal_Event):
    """Message class 'TimedRotation_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<yahboom_rosmaster_msgs/TimedRotation_SendGoal_Request, 1>',
        'response': 'sequence<yahboom_rosmaster_msgs/TimedRotation_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['yahboom_rosmaster_msgs', 'action'], 'TimedRotation_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['yahboom_rosmaster_msgs', 'action'], 'TimedRotation_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from yahboom_rosmaster_msgs.action import TimedRotation_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, TimedRotation_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TimedRotation_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from yahboom_rosmaster_msgs.action import TimedRotation_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TimedRotation_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TimedRotation_SendGoal_Response'"
...
class Metaclass_TimedRotation_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _timed_rotation.Metaclass_TimedRotation_SendGoal_Event._TYPE_SUPPORT is None:
                _timed_rotation.Metaclass_TimedRotation_SendGoal_Event.__import_type_support__()
...
class TimedRotation_SendGoal(metaclass=Metaclass_TimedRotation_SendGoal):
    ...
    from yahboom_rosmaster_msgs.action._timed_rotation import TimedRotation_SendGoal_Event as Event
...
class Metaclass_TimedRotation_GetResult_Event(type):
    """Metaclass of message 'TimedRotation_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__timed_rotation__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__timed_rotation__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__timed_rotation__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__timed_rotation__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__timed_rotation__get_result__event
...
class TimedRotation_GetResult_Event(metaclass=Metaclass_TimedRotation_GetResult_Event):
    """Message class 'TimedRotation_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<yahboom_rosmaster_msgs/TimedRotation_GetResult_Request, 1>',
        'response': 'sequence<yahboom_rosmaster_msgs/TimedRotation_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['yahboom_rosmaster_msgs', 'action'], 'TimedRotation_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['yahboom_rosmaster_msgs', 'action'], 'TimedRotation_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from yahboom_rosmaster_msgs.action import TimedRotation_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TimedRotation_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TimedRotation_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from yahboom_rosmaster_msgs.action import TimedRotation_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TimedRotation_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TimedRotation_GetResult_Response'"
        self._response = value
...
class Metaclass_TimedRotation_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _timed_rotation.Metaclass_TimedRotation_GetResult_Event._TYPE_SUPPORT is None:
                _timed_rotation.Metaclass_TimedRotation_GetResult_Event.__import_type_support__()
...
class TimedRotation_GetResult(metaclass=Metaclass_TimedRotation_GetResult):
    ...
    from yahboom_rosmaster_msgs.action._timed_rotation import TimedRotation_GetResult_Event as Event
