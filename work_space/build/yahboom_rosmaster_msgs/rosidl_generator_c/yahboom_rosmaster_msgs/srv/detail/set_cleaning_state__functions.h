...
#ifndef YAHBOOM_ROSMASTER_MSGS__SRV__DETAIL__SET_CLEANING_STATE__FUNCTIONS_H_
#define YAHBOOM_ROSMASTER_MSGS__SRV__DETAIL__SET_CLEANING_STATE__FUNCTIONS_H_
...
/// Initialize srv/SetCleaningState message.
/**
...
/// Finalize srv/SetCleaningState message.
/**
...
/// Create srv/SetCleaningState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Request__init().
...
/// Destroy srv/SetCleaningState message.
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Request__fini()
...
/// Check for srv/SetCleaningState message equality.
/**
...
/// Copy a srv/SetCleaningState message.
/**
...
/// Initialize array of srv/SetCleaningState messages.
/**
...
/// Finalize array of srv/SetCleaningState messages.
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Request__fini()
...
/// Create array of srv/SetCleaningState messages.
/**
...
/// Destroy array of srv/SetCleaningState messages.
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetCleaningState message array equality.
/**
...
/// Copy an array of srv/SetCleaningState messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboom_rosmaster_msgs
...
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboom_rosmaster_msgs
...
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboom_rosmaster_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboom_rosmaster_msgs
...
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboom_rosmaster_msgs
...
/**
 * It allocates the memory for the array and calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboom_rosmaster_msgs
...
/**
 * It calls
 * yahboom_rosmaster_msgs__srv__SetCleaningState_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // YAHBOOM_ROSMASTER_MSGS__SRV__DETAIL__SET_CLEANING_STATE__FUNCTIONS_H_
