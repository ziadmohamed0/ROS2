...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros2_action.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from ros2_action.srv._add_two_ints import AddTwoInts_Request as Request
    from ros2_action.srv._add_two_ints import AddTwoInts_Response as Response
