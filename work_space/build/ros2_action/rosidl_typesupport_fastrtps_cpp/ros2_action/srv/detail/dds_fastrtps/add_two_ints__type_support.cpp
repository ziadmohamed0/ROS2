...
#include "ros2_action/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_action::srv::AddTwoInts_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2_action::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_action::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &ros2_action::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_action::srv::AddTwoInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_action::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_action::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_action::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &ros2_action::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
