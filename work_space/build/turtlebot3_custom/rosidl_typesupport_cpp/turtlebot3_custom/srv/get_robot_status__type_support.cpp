...
static const _GetRobotStatus_Request_type_support_symbol_names_t _GetRobotStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_custom, srv, GetRobotStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_custom, srv, GetRobotStatus_Request)),
  }
};
...
{
  return &::turtlebot3_custom::srv::rosidl_typesupport_cpp::GetRobotStatus_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_custom, srv, GetRobotStatus_Request)() {
  return get_message_type_support_handle<turtlebot3_custom::srv::GetRobotStatus_Request>();
}
...
static const _GetRobotStatus_Response_type_support_symbol_names_t _GetRobotStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_custom, srv, GetRobotStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_custom, srv, GetRobotStatus_Response)),
  }
};
...
{
  return &::turtlebot3_custom::srv::rosidl_typesupport_cpp::GetRobotStatus_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_custom, srv, GetRobotStatus_Response)() {
  return get_message_type_support_handle<turtlebot3_custom::srv::GetRobotStatus_Response>();
}
...
static const _GetRobotStatus_type_support_symbol_names_t _GetRobotStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_custom, srv, GetRobotStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_custom, srv, GetRobotStatus)),
  }
};
...
{
  return &::turtlebot3_custom::srv::rosidl_typesupport_cpp::GetRobotStatus_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_custom, srv, GetRobotStatus)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlebot3_custom::srv::GetRobotStatus>();
}
