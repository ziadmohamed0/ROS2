  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = franka_msgs::action::ErrorRecovery_Goal;
    is_plain =
      (
...
static size_t _ErrorRecovery_Goal__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_Goal(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_Result;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _ErrorRecovery_Result__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_Result(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_Feedback;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _ErrorRecovery_Feedback__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_Feedback(full_bounded, is_plain, 0);
...
// functions for franka_msgs::action::ErrorRecovery_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_SendGoal_Request;
    is_plain =
      (
...
static size_t _ErrorRecovery_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_SendGoal_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_SendGoal_Response;
    is_plain =
      (
...
static size_t _ErrorRecovery_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_SendGoal_Response(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_GetResult_Request;
    is_plain =
      (
...
static size_t _ErrorRecovery_GetResult_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_GetResult_Request(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for franka_msgs::action::ErrorRecovery_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_GetResult_Response;
    is_plain =
      (
...
static size_t _ErrorRecovery_GetResult_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_GetResult_Response(full_bounded, is_plain, 0);
...
// functions for franka_msgs::action::ErrorRecovery_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::action::ErrorRecovery_FeedbackMessage;
    is_plain =
      (
...
static size_t _ErrorRecovery_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ErrorRecovery_FeedbackMessage(full_bounded, is_plain, 0);
