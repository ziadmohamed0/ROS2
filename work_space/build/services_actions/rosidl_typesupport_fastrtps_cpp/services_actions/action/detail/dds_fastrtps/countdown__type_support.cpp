...
#include "services_actions/action/detail/countdown__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const services_actions::action::Countdown_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_Goal & ros_message)
{
  // Member: start
  cdr >> ros_message.start;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = services_actions::action::Countdown_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_services_actions
const rosidl_message_type_support_t *
get_message_type_support_handle<services_actions::action::Countdown_Goal>()
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_Goal)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: final
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_Result & ros_message)
{
  // Member: final
  cdr >> ros_message.final;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_Result)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: current
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_Feedback & ros_message)
{
  // Member: current
  cdr >> ros_message.current;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_Feedback)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_Feedback__handle;
}
...
// functions for services_actions::action::Countdown_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  services_actions::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  services_actions::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    services_actions::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        services_actions::action::typesupport_fastrtps_cpp::max_serialized_size_Countdown_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_SendGoal_Request)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_SendGoal_Response)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Response__handle;
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_SendGoal)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_GetResult_Request)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for services_actions::action::Countdown_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        services_actions::action::typesupport_fastrtps_cpp::max_serialized_size_Countdown_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_GetResult_Response)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Response__handle;
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_GetResult)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_GetResult__handle;
}
...
// functions for services_actions::action::Countdown_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_services_actions
cdr_serialize(
  const services_actions::action::Countdown_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  services_actions::action::Countdown_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        services_actions::action::typesupport_fastrtps_cpp::max_serialized_size_Countdown_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::action::Countdown_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::action::Countdown_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::action::Countdown_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_actions, action, Countdown_FeedbackMessage)() {
  return &services_actions::action::typesupport_fastrtps_cpp::_Countdown_FeedbackMessage__handle;
}
