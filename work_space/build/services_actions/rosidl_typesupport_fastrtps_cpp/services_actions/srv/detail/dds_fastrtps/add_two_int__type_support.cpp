...
#include "services_actions/srv/detail/add_two_int__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = services_actions::srv::AddTwoInt_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const services_actions::srv::AddTwoInt_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<services_actions::srv::AddTwoInt_Request *>(
    untyped_ros_message);
...
{
  return &services_actions::srv::typesupport_fastrtps_cpp::_AddTwoInt_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = services_actions::srv::AddTwoInt_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const services_actions::srv::AddTwoInt_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<services_actions::srv::AddTwoInt_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &services_actions::srv::typesupport_fastrtps_cpp::_AddTwoInt_Response__handle;
}
...
{
  return &services_actions::srv::typesupport_fastrtps_cpp::_AddTwoInt__handle;
}
