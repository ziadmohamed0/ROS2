...
ros2_service__msg__Sphere__init(ros2_service__msg__Sphere * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->center)) {
    ros2_service__msg__Sphere__fini(msg);
    return false;
  }
  // radius
  return true;
...
ros2_service__msg__Sphere__create(void)
{
  ...
  ros2_service__msg__Sphere * msg = (ros2_service__msg__Sphere *)allocator.allocate(sizeof(ros2_service__msg__Sphere), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_service__msg__Sphere));
  bool success = ros2_service__msg__Sphere__init(msg);
  if (!success) {
...
ros2_service__msg__Sphere__Sequence__init(ros2_service__msg__Sphere__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_service__msg__Sphere * data = NULL;

  if (size) {
    data = (ros2_service__msg__Sphere *)allocator.zero_allocate(size, sizeof(ros2_service__msg__Sphere), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_service__msg__Sphere__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2_service__msg__Sphere__fini(&data[i - 1]);
      }
...
ros2_service__msg__Sphere__Sequence__fini(ros2_service__msg__Sphere__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_service__msg__Sphere__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_service__msg__Sphere__Sequence * array = (ros2_service__msg__Sphere__Sequence *)allocator.allocate(sizeof(ros2_service__msg__Sphere__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_service__msg__Sphere__Sequence__init(array, size);
  if (!success) {
...
ros2_service__msg__Sphere__Sequence__destroy(ros2_service__msg__Sphere__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_service__msg__Sphere__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_service__msg__Sphere__Sequence__are_equal(const ros2_service__msg__Sphere__Sequence * lhs, const ros2_service__msg__Sphere__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_service__msg__Sphere__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_service__msg__Sphere__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_service__msg__Sphere);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_service__msg__Sphere * data =
      (ros2_service__msg__Sphere *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_service__msg__Sphere__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_service__msg__Sphere__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_service__msg__Sphere__copy(
