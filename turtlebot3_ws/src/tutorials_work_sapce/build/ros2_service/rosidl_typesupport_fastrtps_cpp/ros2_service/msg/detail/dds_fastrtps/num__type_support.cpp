...
#include "ros2_service/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_service::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_service::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_service::msg::Num *>(
    untyped_ros_message);
...
{
  return &ros2_service::msg::typesupport_fastrtps_cpp::_Num__handle;
}
