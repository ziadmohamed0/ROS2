...
#include "ros2_service/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_service::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_service::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_service::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &ros2_service::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
