...
bool ros2_service__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_service.msg._num.Num", full_classname_dest, 25) == 0);
  }
  ros2_service__msg__Num * ros_message = _ros_message;
  {  // num
...
PyObject * ros2_service__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_service.msg._num");
