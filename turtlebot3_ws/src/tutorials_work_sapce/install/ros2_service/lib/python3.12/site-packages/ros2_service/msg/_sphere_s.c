...
bool ros2_service__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_service.msg._sphere.Sphere", full_classname_dest, 31) == 0);
  }
  ros2_service__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * ros2_service__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_service.msg._sphere");
