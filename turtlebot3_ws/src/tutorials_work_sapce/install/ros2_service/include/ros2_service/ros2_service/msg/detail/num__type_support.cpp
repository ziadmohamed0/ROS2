...
{
  new (message_memory) ros2_service::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_service::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[1] = {
  {
    ...
    offsetof(ros2_service::msg::Num, num),  // bytes offset in struct
...
{
  return &::ros2_service::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_service, msg, Num)() {
  return &::ros2_service::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
