...
static const _Goal_Event_type_support_symbol_names_t _Goal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_msgs, srv, Goal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, srv, Goal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_msgs, srv, Goal_Event)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_c::Goal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Goal_service_type_support_handle = {
  ...
  &Goal_Request_message_type_support_handle,
  &Goal_Response_message_type_support_handle,
  &Goal_Event_message_type_support_handle,
