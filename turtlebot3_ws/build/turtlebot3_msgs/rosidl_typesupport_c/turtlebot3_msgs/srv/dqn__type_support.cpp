...
static const _Dqn_Request_type_support_symbol_names_t _Dqn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_msgs, srv, Dqn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, srv, Dqn_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_msgs, srv, Dqn_Request)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_c::Dqn_Request_message_type_support_handle;
}
...
static const _Dqn_Response_type_support_symbol_names_t _Dqn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_msgs, srv, Dqn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, srv, Dqn_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_msgs, srv, Dqn_Response)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_c::Dqn_Response_message_type_support_handle;
}
...
typedef struct _Dqn_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _Dqn_Event_type_support_ids_t;

static const _Dqn_Event_type_support_ids_t _Dqn_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _Dqn_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _Dqn_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _Dqn_Event_type_support_symbol_names_t _Dqn_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_msgs, srv, Dqn_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, srv, Dqn_Event)),
  }
};

typedef struct _Dqn_Event_type_support_data_t
{
  void * data[2];
} _Dqn_Event_type_support_data_t;

static _Dqn_Event_type_support_data_t _Dqn_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _Dqn_Event_message_typesupport_map = {
  2,
  "turtlebot3_msgs",
  &_Dqn_Event_message_typesupport_ids.typesupport_identifier[0],
  &_Dqn_Event_message_typesupport_symbol_names.symbol_name[0],
  &_Dqn_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t Dqn_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_Dqn_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_msgs, srv, Dqn_Event)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_c::Dqn_Event_message_type_support_handle;
}
...
static const _Dqn_type_support_symbol_names_t _Dqn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_msgs, srv, Dqn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, srv, Dqn)),
  }
};
...
static const rosidl_service_type_support_t Dqn_service_type_support_handle = {
  ...
  &Dqn_Request_message_type_support_handle,
  &Dqn_Response_message_type_support_handle,
  &Dqn_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_msgs, srv, Dqn)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_c::Dqn_service_type_support_handle;
}
