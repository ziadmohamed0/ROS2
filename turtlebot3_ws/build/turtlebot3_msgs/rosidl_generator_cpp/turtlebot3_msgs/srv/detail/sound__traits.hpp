...
inline std::string to_yaml(const Sound_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use turtlebot3_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlebot3_msgs::srv::Sound_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlebot3_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlebot3_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const turtlebot3_msgs::srv::Sound_Event & msg)
{
  return turtlebot3_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<turtlebot3_msgs::srv::Sound_Event>()
{
  return "turtlebot3_msgs::srv::Sound_Event";
}

template<>
inline const char * name<turtlebot3_msgs::srv::Sound_Event>()
{
  return "turtlebot3_msgs/srv/Sound_Event";
}

template<>
struct has_fixed_size<turtlebot3_msgs::srv::Sound_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<turtlebot3_msgs::srv::Sound_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<turtlebot3_msgs::srv::Sound_Request>::value && has_bounded_size<turtlebot3_msgs::srv::Sound_Response>::value> {};

template<>
struct is_message<turtlebot3_msgs::srv::Sound_Event>
  : std::true_type {};
