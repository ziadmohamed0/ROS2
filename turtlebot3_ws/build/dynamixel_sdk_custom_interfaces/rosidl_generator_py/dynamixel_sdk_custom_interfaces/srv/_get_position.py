...
class GetPosition_Event(metaclass=Metaclass_GetPosition_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dynamixel_sdk_custom_interfaces/GetPosition_Request, 1>',
        'response': 'sequence<dynamixel_sdk_custom_interfaces/GetPosition_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dynamixel_sdk_custom_interfaces', 'srv'], 'GetPosition_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dynamixel_sdk_custom_interfaces', 'srv'], 'GetPosition_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dynamixel_sdk_custom_interfaces.srv import GetPosition_Request
    ...
    def response(self, value):
        if self._check_fields:
            from dynamixel_sdk_custom_interfaces.srv import GetPosition_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dynamixel_sdk_custom_interfaces.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from dynamixel_sdk_custom_interfaces.srv._get_position import GetPosition_Request as Request
    from dynamixel_sdk_custom_interfaces.srv._get_position import GetPosition_Response as Response
    from dynamixel_sdk_custom_interfaces.srv._get_position import GetPosition_Event as Event
