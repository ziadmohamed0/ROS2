...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__create(void)
{
...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__init(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(msg);
    return false;
  }
  // request
  if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence__init(&msg->request, 0)) {
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(msg);
    return false;
  }
  // response
  if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence__init(&msg->response, 0)) {
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(msg);
    return false;
  }
  return true;
...
void
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence__fini(&msg->request);
  // response
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence__fini(&msg->response);
}

bool
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__are_equal(const dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * lhs, const dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence__are_equal(
...
bool
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__copy(
  const dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * input,
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__Sequence__copy(
...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * msg = (dynamixel_sdk_custom_interfaces__srv__GetPosition_Event *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event));
  bool success = dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__destroy(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(msg);
...
bool
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__init(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * data = NULL;

  if (size) {
    data = (dynamixel_sdk_custom_interfaces__srv__GetPosition_Event *)allocator.zero_allocate(size, sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__fini(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * array = (dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__destroy(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__are_equal(const dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * lhs, const dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence__copy(
  const dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * input,
  dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Event * data =
      (dynamixel_sdk_custom_interfaces__srv__GetPosition_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__srv__GetPosition_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
