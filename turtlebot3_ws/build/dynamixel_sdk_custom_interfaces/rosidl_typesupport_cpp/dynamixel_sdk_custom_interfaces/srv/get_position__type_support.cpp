...
static const _GetPosition_Event_type_support_symbol_names_t _GetPosition_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, srv, GetPosition_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_custom_interfaces, srv, GetPosition_Event)),
  }
};
...
{
  return &::dynamixel_sdk_custom_interfaces::srv::rosidl_typesupport_cpp::GetPosition_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_sdk_custom_interfaces, srv, GetPosition_Event)() {
  return get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::GetPosition_Event>();
}
...
static const rosidl_service_type_support_t GetPosition_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::GetPosition_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::GetPosition_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::GetPosition_Event>(),
